...
namespace Laobian.Share.Blog.Repository
{
    public class BlogPostRepository : IBlogReadonlyRepository
    {
        ...
        public async Task PullAsync()
        {
            ...
            var command =
                $"{_blogSetting.CommandLineArgQuote}set-x && trap read debug && git clone -b {_blogSetting.GitHubReadonlyRepoBranch} --single-branch {repoUrl} {_blogSetting.GitHubReadonlyRepoLocalDir}{_blogSetting.CommandLineArgQuote}";
